<div class="col-xs-12" style="text-align: center;">
      <h3 style="font-weight: bold;"><?= __('Pronóstico de Facturación') ?></h3>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <p style="text-align: right;margin: 10px 0;">
            <a  href="/cotizaciones/pronosticos-facturacion/pdf"
                target="_blank"
...
<script type="text/javascript">
    $(function () {
        ...
        $('.timeline .events li span.date').on('click', function(){
            ...
            $.get('/cotizaciones/pronosticos-facturacion/0/1/' + created1 + '/' + created2, function(response){
