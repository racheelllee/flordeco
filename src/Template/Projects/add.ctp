                      ...
                      <label class="col-sm-6 control-label"><?=  __('Proyecto_inicio'); ?></label>
                        <div class="col-sm-6">
                          <div class="input-group relative-absolute">
                            <?= $this->Form->input('proyecto_inicio', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="um-form-row form-group">
                      <label class="col-sm-6 control-label"><?=  __('Proyecto_final_entrega_ejecutivo'); ?></label>
                        <div class="col-sm-6">
                          <div class="input-group relative-absolute">
                            <?= $this->Form->input('proyecto_final_entrega_ejecutivo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                            <span class="input-group-btn">
                                <button class="btn default" type="button">
                                    <i class="fa fa-calendar"></i>
                                </button>
                ...
                <div class="col-sm-4">
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_str_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_ac_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_ac_str_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_ac_iluminacion_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_hid_san_gas_plu_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('cruce_inst_especiales_fecha_vobo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('dia_hora_sup_bernardo', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datetimepicker', 'data-format'=>'dd/MM/yyyy hh:mm:ss']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_etapa_6a', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_etapa_6b', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_etapa_6c', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_etapa_6d', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                ...
                <div class="col-sm-6">
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_inicio_obra', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                    ...
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_real_fin_obra', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                ...
                <div class="col-sm-6">
                    <div class="um-form-row form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group relative-absolute">
                                <?= $this->Form->input('fecha_contratada_fin_obra', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control datepicker']); ?>
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
