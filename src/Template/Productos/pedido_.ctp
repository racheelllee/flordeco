<?php
  ...
  $logeado = 0; //debug($this->request->session()->read('codigo_postal')); die;
...
<div id="content" class="secbg">
  <div class="container">
   <?php // $this->Form->create($pedido, array('id' => 'formulario'));  ?>
    <div id="carrito_2">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="step_01">
          ...
          <div class="block_1 ">
            ...
            <div class="row lpt">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 centrado_div">
                    <div class="div_radio">
                      <input type="radio" class="radio recoger_sucursal" value="0" name="recoger_sucursal_check" id="radio1" checked> 
                      <label class="label_radio" for="radio1">Enviar a Domicilio</label>
                    </div>
                    <div class="div_radio">
                      <input type="radio" class="radio recoger_sucursal" value="1" name="recoger_sucursal_check" id="radio2"> 
                      <label class="label_radio" for="radio2">Recoger en Sucursal</label>
                    </div>
                </div>
            </div>
         
            <div id="sin_direccion" style="display:none;">

               
                
                
                <H4>¿EN QUÉ SUCURSAL RECOGERÁS TU PEDIDO?</H4>
                ...
                <div class="blk_1">
                  ...
                  <div class="row" style="padding:10px;">
                    ...
                    <div class="col-xs-12">
                      <strong class="sucursal_text">
                      <input type="radio" class="radio_sucursal" value="<?php echo $sucursal->id; ?>" name="sucursal" data-forma="sucursal_<?php echo $sucursal->id; ?>" <?php if($sucursal->id == 1){ echo "checked"; } ?>> &nbsp;&nbsp;&nbsp;<?php echo $sucursal->nombre; ?></strong>
                  ...
                  <block class="sucursal_block" id="sucursal_<?php echo $sucursal->id; ?>"  <?php if($sucursal->id != 1){ ?> style="display:none;" <?php } ?> >
                    <p><?php echo $sucursal->detalles; ?></p>
                  </block>
                ...
                <div id="dato_facturacion_sucursal">
                    <ul class="dir-env">
                    ...
                    <div class="row">
                      <a class="btn btn-default" href="#" id="editar_datos_facturacion_sucursal" style="margin-left: 35px;">Editar Datos de Facturación</a>
                      <a class="ps_1 btn btn-info" id="continuar_enSucursal" style="float: right; margin-right: 28px;">Continuar</a>
                    </div>
                </div>
                <div id="datos_factura2" style="display : none;">

                  <form id="datos_facturacion_sucursal"> 
                  ...
                  <div class="form-align">
                    <label class="label_text">Razón Social *</label>
                  ...
                  <div class="form-align">
                    ...
                    <?php echo $this->Form->input('entre_calles_fiscal', array('class'=>'textbox_1 ', 'label'=>false, 'value' => $usuario['entre_calles'])); ?>
                  </div>
                  <div class="form-align">
                  ...
                  <div class="btnbox row">
                     <a href="#" class="cancelar_datos_envio" id="cancelar_datos_envio">Cancelar</a>

                      <a class="btn btn-info" id="guardar_datos_facturacion_sucursal" style="margin-left: 2% !important; clear: none !important; float: left;">Guardar</a>
                  </div>
                ...
                <H4>¿AGREGAR DATOS DE FACTURACIÓN? 
                  <input type="radio" class="radio_1" value="1" name="facturar_" id="facturar2" style="margin-left:10px;"> Sí
                  <input type="radio" class="radio_1" value="0" name="facturar_" id="facturar2" style="margin-left:10px;" checked> No
                </H4>
                
                
                <BR><BR>

                <div id="datos_factura2" style="display : none;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="btnbox">
                    <a class="ps_1 btn btn-info" id="continuar_enSucursal">Continuar</a>

                    <a class="btn btn-info" id="guardar_datos_facturacion_sucursal" style="display:none;">Guardar Datos de Facturación</a>
                </div>

                <!-- FINALIZA DATOS FACTURACION NUEVOS-->
          ...
          <div id="direcciones">  
            ...
            <div  style="display:none;" id='editar_datos_usuario'>
              ...
              <form id="nuevos_datos_envio">
                ...
                <div class="form-align">
                  <label class="label_text">Entre Calles</label>
                  <?php echo $this->Form->input('entre_calles', array('class'=>'textbox_1', 'label'=>false, 'value'=> $direccion_envio->entre_calles)); ?>
                </div>
                <div class="form-align">
                  <label class="label_text">Código Postal *</label>
                ...
                <div class="form-align">
                  <ul class="radiobox dbl ldb">
                    <li><p>¿Agregar datos de Facturación?</p></li>
          ...
          <div class="block_1">
            ...
            <!--
              ...
              -->
            <br>     
            <ul id="myTab" class="nav nav-tabs mune tabspaso1" role="tablist">
              <li role="presentation" class="active tabpaso1" id="registrarme_active">
                <a id="registrarme"> Registrarme </a>
              </li>
              <li role="presentation" class="tabpaso1" id="logearme_active">
                <a id="logearme"> Ya estoy Registrado </a>
              </li>
              <li role="presentation" class="tabpaso1" id="compra_invitado_active">
                <a id="compra_invitado"> Compra Invitado </a>
              </li>
            </ul>

            <div id="compra_invitado_form" style="display:none;">


              <div class="row-invitado">
                <?php echo $this->Form->create($userEntity, ['url'=>'/pedido/recogersucursal', 'id'=>'loginForm', 'class'=>'m-t']); ?>

                <input type="hidden" name="modo_invitado" value="1" />
                <div class="row ">
                      ...
                      <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <?php echo $this->Form->input('correoinvitado', ['type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>__('Correo Electrónico'), 'class'=>'form-control']); ?>
                ...
                <div class="row ">
                      ...
                      <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center" >
                        ...
                        <input id="modo_invitado" type="submit" value="continuar" class="btn btn-primary" />
                          </div>
                      </div>
            ...
            <div id="registrarme_form">
              ...
              <div class="form-align">
                <?php echo $this->Form->input('telefono_local', array('class'=>'textbox_1 requerido', 'label'=>false, 'placeholder'=>'Teléfono *')); ?>
              </div>
              <div class="form-align">
                <?php echo $this->Form->input('telefono_celular', array('class'=>'textbox_1', 'label'=>false,  'placeholder'=>'Celular ')); ?>
              </div>
              <div class="form-align">
              ...
              <div class="form-align">
                ...
                <div style="color: #ccc; font-size: 7px:">Debe de contener más de 6 caracteres.</div>
              </div>
              <div class="form-align">
        ...
        <input type="hidden" name="recoger_sucursal" id="recoger_sucursal" value="<?php echo $recoger_sucursal   ?>">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="step_02">
          <div class="block_2 <?php echo $classb2;?>">
            ...
            <div class="blk_1" style="margin-bottom:-50px;">
              ...
              <?php   $checked = ($formasdepago_id == $FormadePago->id )? 'checked="checked"' : " " ?>
              <input <?php echo $checked ?> type="radio" class="radio_1 pjd" value="<?php echo $FormadePago->id; ?>" name="formasdepago_id" data-id="<?php echo $FormadePago->id; ?>" data-forma="forma_<?php echo $FormadePago->id; ?>">
              ...
              <block class="forma_pago" id="forma_<?php echo $FormadePago->id; ?>" style="display:none;">
            ...
            <a class="ps_2-back btn btn-default" href="<?php echo (strpos($_SERVER['HTTP_REFERER'], "pedido/recogersucursal"))? '/pedido/recogersucursal' : $_SERVER['HTTP_REFERER'] ?>">Regresar</a>        
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="step_03">
          <div class="block_3">
            ...
            <div class="pedido_sn">
              ...
              <div class="line_2">
                <div class="ptotales">
                  <span>Subtotal</span><p>$<?php echo number_format($subtotal,2); ?></p>
              ...
              <a class="ps_3 btn btn-default" href="<?php echo $_SERVER['HTTP_REFERER'] ?>">Regresar</a> 
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color:#1e547f; color:white;">
        ...
        <div style="float:left; margin-right:30px; margin-top:-4px;">
          <h4 class="modal-title">Encuentra tu Código Postal</h4>
        </div>
...
<script type="text/javascript">
  ...
  $('#editar_datos_facturacion_sucursal').click(function(){
      $("#dato_facturacion_sucursal").css("display", "none");
      $("#datos_factura2").css("display", "block");
  });
  ...
  var ocultas_div_forms_tabs = function(){

      $("#registrarme_form").css("display", "none");
      $("#logearme_form").css("display", "none");
      $("#compra_invitado_form").css("display", "none");


  }
  

  var remove_class_active_tabs = function(){

    $('#logearme_active').removeClass('active');
    $('#registrarme_active').removeClass('active');
    $('#compra_invitado_active').removeClass('active');

  }
  
  $('#logearme').click(function(){
      ocultas_div_forms_tabs();
      remove_class_active_tabs();
  ...
  $('#compra_invitado').click(function(){
      ocultas_div_forms_tabs();
      remove_class_active_tabs();
      

      $("#compra_invitado_form").css("display", "block");
      

      $('#compra_invitado_active').addClass('active');
  ...
  $(document).on({click: function(e){
      ...
      $(".sucursal_block").css("display", "none");
      $("#"+forma).css("display", "block");
  
      $("#sucursal_id").val(_this.val());
  ...
  $(document).on({click: function(e){
      ...
      if(_this.val() == 1){
          ...
          //$("#sin_direccion").css("display", "block");


          // 
          <?php  if( !$inRecogerSucursal ){ ?>


        
    
           location.href = "<?php echo $this->Url->build(["action" => "pedido"]) . "/recogersucursal" ; ?>";
          ...
          <?php // echo $this->Url->build(["action" => "pedido"]) . "/recojersucursal" ; ?>
          ...
          //$("#sin_direccion").css("display", "none");
          ...
          <?php  if( !$inDireccion ){ ?>
           ...
           location.href = "<?php echo $this->Url->build(["action" => "pedido"]) . "/direccion" ; ?>";
  ...
  $(document).on({click: function(e){
      ...
      {
          $("#datos_factura2").css("display", "block");
          $("#continuar_enSucursal").fadeOut();
          $("#guardar_datos_facturacion_sucursal").fadeIn();
      }else{
          $("#datos_factura2").css("display", "none");
          $("#continuar_enSucursal").fadeIn();
          $("#guardar_datos_facturacion_sucursal").fadeOut();
      }
  ...
  $('#finalizar_compra').click(function(){
      ...
      var recoger_sucursal = $('#recoger_sucursal').val();
          ...
          if($('#datos_usuario_nuevos').is(":visible")){
              ...
              if(forma_pago != undefined){
                  ...
                  if($('#editar_datos_usuario').is(":visible")){
                      ...
                      if(codigo == 0 && recoger_sucursal == 0){
  
                          alert('El codigo postal es muy importante para calcular el envío');
                          

                          $('#formulario').attr('action','/pedido/direccion');
      ...
      if(valido == 1){
          ...
          $.ajax({
                      ...
                      success: function(data){
                          ...
                          $(location).attr('href','/pedido/direccion');
  ...
  $('#guardar_datos_nuevos').click(function(){
      ...
      if($('#datos_factura').is(":visible")){
          ...
          $("#datos_factura .requerido_factura").each(function (index) { 
              if($(this).val() == ''){
                  $(this).addClass('obligatorio');
...
$('#guardar_datos_facturacion_sucursal').click(function(){
      
  
      var valido = 1;
  
     
      $("#datos_factura2 .requerido_factura").each(function (index) { 
      ...
      if(valido == 1){
          ...
          $.ajax({
                      ...
                      type: 'POST',
                      url: '<?php echo $this->Url->build(["action" => "editar_datos_usuario"]); ?>',
                      data: $('#datos_facturacion_sucursal').serialize(),
                      dataType: 'json',
                      success: function(data){
  ...
  */
  ...
  $( ".ps_1" ).click(function() {
    ...
    $('#formulario').attr('action','/pedido/formapago');
...
<?php 
 ...
 ?>
  ...
  $( ".ps_2" ).click(function() {
    ...
    if( ( recoger_sucursal != "" )  &&   ( sucursal_id != ""  ) ){

      var forma_pago_id = $('.formas_pg input:checked').data('id');
      $('#formulario').attr('action','/pedido/confirmar/'+ forma_pago_id );

      $('#formulario').submit();

    }else{

      alert( "Método de envio no valido ");
...
<?php 
  ...
  $( ".ps_2-back" ).click(function() {
    ...
    <?php  if( $inRecogerSucursal ){ ?>
        ...
        $('.recoger_sucursal:last').trigger('click');
    ...
    <?php  if( $inDireccion ){ ?>
        ...
        $('.recoger_sucursal:first').trigger('click');
    ...
    <?php if( $inConfirmar ){  ?>
      ...
      $('#formulario').attr('action','/pedido' );

      $("#step_01").hide();
      $("#step_03").css('opacity',1);
      $("#step_03").show()
