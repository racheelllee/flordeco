...
<div class="ibox">
    ...
    <?= $this->Form->create($cotizaciones , [ 'id'=>'cotizacion-form', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data', 'novalidate', 'url' => "cotizaciones/edit/{$cotizaciones->id}/{$customers->id}"] ); ?>
    ...
    <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        <div class="input-group relative-absolute">
                            <?= $this->Form->input('fecha_solicitud', [
                                ...
                                'value' => (!empty($cotizaciones->fecha_solicitud)) ?
                                            $cotizaciones->fecha_solicitud->format('d/m/Y') : ''
                            ]); ?>
        ...
        <div class="col-md-6">
            <div class="um-form-row form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group relative-absolute">
                            <?= $this->Form->input('fecha_entrega_cliente', ['type'=>'text', 'label'=>false,'div'=>false, 'class'=>'form-control minToDay', 'value'=>(!empty($cotizaciones->fecha_entrega_cliente))? $cotizaciones->fecha_entrega_cliente->format('d/m/Y') : '' ]); ?>
                            <span class="input-group-btn">
                                <button class="btn default" type="button">
                                    <i class="fa fa-calendar"></i>
                                </button>
        ...
        <div class="col-md-6">
            <div class="um-form-row form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group relative-absolute">
                        <?= $this->Form->input('fecha_entrega_real', [
                            'type' => 'text',
                            'label' => false,
                            'div' => false,
                            'class' => 'form-control minToDay',
                            'value' => (!empty($cotizaciones->fecha_entrega_real)) ?
                ...
                <div class="col-md-8">
                    <div class="input-group relative-absolute">
                        <?= $this->Form->input('fecha_estimada_compra', [
                            ...
                            'div'=>false,
                            'class'=>'form-control minToDay',
                            'value' => (!empty($cotizaciones->fecha_estimada_compra)) ?
        ...
        <div class="col-md-6">
            <div class="um-form-row form-group">
                ...
                <div class="col-md-8">
                    <?= $this->Form->input('vendedor_asignado_id', ['label'=>false, 'div'=>false, 'class'=>'form-control', 'options' => $userAssigned, 'empty' => '[Selecciona una opción]']); ?>
            ...
            <div class="um-form-row form-group">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input('moneda_id', ['label'=>false, 'div'=>false, 'class'=>'form-control', 'options' => $moneda, 'id'=>'moneda']); ?>
                    </div>

                    <div class="col-md-6">
                        <label class="control-label"><?php echo __('Tipo de Cambio'); ?></label>
                        <?= $this->Form->input('tipo_cambio', ['type' => 'text','label'=>false, 'div'=>false, 'class'=>'form-control decimal']); ?>
                    </div>
                </div>
                <div class="col-md-8">
