...
<div class="clearfix">
    ...
    <div id="updateInteractionsIndex">
        ...
        <div class="col-xs-6 w-title w-color666">
              <span style="position: absolute; margin-top:10px;"><?= __('Reporte de Interacciones por Vendedor') ?></span>
        </div>
        ...
        <p style="text-align: right;margin: 10px 0;">
            <a href="/interactions/reporte-por-vendedor/pdf" target="_blank" class="btn btn-default" style="border: 1px solid #17aa8f;color: #777;">PDF</a>
        </p>
