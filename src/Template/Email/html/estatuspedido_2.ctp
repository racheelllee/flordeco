...
<body>
	...
	<p><strong>EN LOS PROXIMOS MINUTOS</strong> recibirás un correo electrónico de <strong>CONFIRMACIÓN</strong>. En algunos casos es instantáneo y en otros nos tardamos unos minutos para revisar tu pedido.</p>

	<p><strong>SI COMPRASTE EN HORARIO NOCTURNO</strong> te mandaremos la <strong>CONFIRMACIÓN</strong> a primera hora del siguiente día hábil.</p>

	<img src="<?php echo $URL?>email/body-2.png" style="width:100%;">
