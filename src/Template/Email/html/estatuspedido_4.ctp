...
<body>
	...
	<img src="<?php echo $URL?>email/header-enviado.png" style="width:100%;">

	<?= $this->element('email_estatus_pedido/info_general', ['pedido'=>$pedido]) ?>

	<h3>Su pedido ha sido enviado</h3>

	<p>El dia de entrega te avisaremos por este medio el cambio de estatus de tu regalo, hasta notificarte las buenas noticias con la entrega final!</p>
