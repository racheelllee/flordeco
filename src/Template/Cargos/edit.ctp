    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="col-xs-12 clearfix">
                <div class="um-form-row form-group">
                    <label class="col-sm-12 control-label" style="text-align: left;padding-left: 14px;">
                        <?=  __('Customer'); ?>
                    </label>
                    <div class="col-sm-12">
                ...
                <div class="um-form-row form-group">
                    <div class="col-sm-12">
                        <?= $this->Form->input('Cargos.fecha_apertura', [
                            ...
                            'value' => $cargos->has('fecha_apertura') ? $cargos->fecha_apertura->format('d/m/Y') : '',
                        ]); ?>
                    </div>
                </div>
            </div>
                ...
                <div class="um-form-row form-group">
                    <div class="col-sm-12">
                        <?= $this->Form->input('Cargos.fecha_estimada_cierre', [
                            ...
                            'value' => $cargos->has('fecha_estimada_cierre') ? $cargos->fecha_estimada_cierre->format('d/m/Y') : '',
                        ]); ?>
                    </div>
                </div>
            </div>
