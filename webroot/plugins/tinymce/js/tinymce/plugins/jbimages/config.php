...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/img/banners'; // Relative to domain name
	$config['upload_path'] = '/img/banners/';# $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
